...
export function AiStudyBuddy({ courseId, lessonId, courseName }: Props) {
  ...
  const [messages,  setMessages]  = useState<Message[]>([
    { role: 'assistant', content: isPublic
        ? "Hi! 👋 I'm the laximotech.ai AI Assistant. Ask me anything about courses, pricing, or career paths — no login required!"
        : `Hi! 👋 I'm your AI Study Buddy. Ask me anything about ${courseName ? `"${courseName}"` : 'this course'} — I'm here to help!` },
  ]);
                  ...
                  <div className="px-3 py-3 border-t border-gray-100 flex-shrink-0">
                    ...
                    <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-xl px-3 py-2 focus-within:border-brand-orange focus-within:ring-2 focus-within:ring-brand-orange/20 transition-all">
                      <input
                        ...
                        placeholder={isPublic || session ? 'Type your question...' : 'Login required'}
