...
const steps = [
  { icon: ShoppingCart, num: '01', color: 'bg-blue-100 text-brand-blue', title: 'Choose & Pay', desc: 'Pick your course. Pay just Rs 399 via UPI, Cards, or Wallets. Get instant confirmation.' },
  { icon: Play,         num: '02', color: 'bg-orange-100 text-brand-orange', title: 'Watch & Learn', desc: 'Watch HD videos. Speed control, subtitles, bookmarks — learn at your own pace.' },
  { icon: Brain,        num: '03', color: 'bg-purple-100 text-purple-600', title: 'Practice & Build', desc: 'Solve quizzes, write code right in your browser. Build real projects for your portfolio.' },
  { icon: Award,        num: '04', color: 'bg-green-100 text-brand-green', title: 'Get Certified', desc: 'Complete the course and earn a verifiable certificate. Share it on LinkedIn, use it for jobs.' },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="section-title mt-2">
            Become an Expert in <span>4 Simple Steps</span>
          </motion.h2>
        </div>
