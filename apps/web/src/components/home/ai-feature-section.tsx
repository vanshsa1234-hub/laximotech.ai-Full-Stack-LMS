...
const features = [
  { icon: MessageSquare, title: 'Ask Anything, Anytime', desc: 'Just say "I didn\'t understand this concept" and get an instant, clear explanation.' },
  { icon: BookOpen,      title: 'Course-Context Aware',    desc: 'Only talks about the current lesson — no distractions, maximum focus.' },
  { icon: Zap,           title: 'Instant Answers 24/7',   desc: 'Have a doubt at 2am? Your AI Study Buddy is always available. No waiting.' },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-gray-500 leading-relaxed mb-8">
              ...
              it explains, quizzes you back, and keeps you on track.
            </p>
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <div className="bg-gray-900 rounded-3xl p-6 shadow-[0_30px_80px_rgba(0,0,0,0.2)] relative">
              ...
              <div className="space-y-4">
                {[
                  { role: 'user', msg: 'What is a neural network? Explain it simply 🙏', delay: 0.2 },
                  { role: 'ai',   msg: 'Sure! A neural network is a system that works like the human brain. Just like your brain has neurons, a neural network has "nodes" that are all interconnected...', delay: 0.6 },
                  { role: 'user', msg: 'Can you give a real-life example?', delay: 1.0 },
                  { role: 'ai',   msg: '✅ Real example: When you search "dog" in Google Photos — a neural network is what recognizes the dog in your photos! That\'s Image Recognition at work. Want to learn about CNNs (Convolutional Neural Networks) next?', delay: 1.4 },
                ].map((item, i) => (
              ...
              <div className="mt-5 flex items-center gap-2 bg-gray-800 rounded-xl px-4 py-3">
                <input className="flex-1 bg-transparent text-gray-400 text-sm outline-none placeholder:text-gray-600"
                  placeholder="Type your doubt..." readOnly />
