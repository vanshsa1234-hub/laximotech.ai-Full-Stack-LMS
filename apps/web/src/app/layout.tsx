...
export const metadata: Metadata = {
  ...
  description: 'Learn AI, Machine Learning, Data Science, Robotics & Cybersecurity in Hindi at just Rs 399 per course. Get a verifiable certificate. Job-ready skills for Indian students.',
  keywords: ['AI course Hindi', 'Machine Learning course India', 'Data Science Hindi', 'Rs 399 course', 'tech course Greater Noida', 'Python course Hindi', 'affordable tech education India'],
  ...
  openGraph: {
    ...
    description: 'Learn AI, ML, Data Science in Hindi. Only Rs 399. Certificate included.',
    images: [{ url: '/og-image.png', width: 1200, height: 630 }],
  },
  twitter: {
    card:        'summary_large_image',
    title:       'laximotech.ai — AI & Tech Courses at Rs 399',
    description: 'Learn AI, ML, Data Science in Hindi. Only Rs 399.',
    images:      ['/og-image.png'],
  },
  robots: {
