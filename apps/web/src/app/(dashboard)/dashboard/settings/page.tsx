...
import { Settings, Bell, Shield, LogOut, Trash2, ChevronRight, KeyRound, Loader2, Check } from 'lucide-react';
import { authApi, usersApi } from '@/lib/api';
import { useProfile } from '@/hooks/use-queries';
import toast from 'react-hot-toast';

const DEFAULT_PREFS = { notifications: { email: true, streak: true, weekly: false } };
...
export default function SettingsPage() {
  ...
  const savePreferences = async (nextNotifs: typeof notifs) => {
    setSavingPrefs(true);
    try {
      await usersApi.update({ preferences: { notifications: nextNotifs } });
