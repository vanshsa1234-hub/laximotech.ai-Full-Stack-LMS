          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <p className="text-white/75 text-lg max-w-xl mx-auto">
                Take a free class, talk directly with an instructor, get your questions answered — then decide.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-card border border-gray-100">
                <h3 className="font-heading font-semibold text-gray-900 mb-4">What You'll Get in the Demo Class:</h3>
                <div className="space-y-3">
                  {[
                    '45-minute live session with an expert instructor',
                    'Course curriculum walkthrough',
                    'Live Q&A — ask any question you have',
              ...
              {booked ? (
                <div className="text-center py-10">
                  ...
                  <p className="text-gray-500 mb-2">
                    <strong>{form.name}</strong>, your demo class has been booked.
                  </p>
