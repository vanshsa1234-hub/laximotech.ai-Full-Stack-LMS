      ...
      <main className="min-h-screen bg-brand-ice">
        <div className="bg-mesh pt-28 pb-20 text-center">
          ...
          <h1 className="font-heading font-bold text-white text-4xl md:text-5xl mb-4">
            Apni Team ko <span className="text-brand-orange">Upskill Karein</span>
          </h1>
          <p className="text-white/75 text-lg max-w-xl mx-auto mb-8">
            AI, Data Science aur Tech skills apni puri company mein — bulk pricing ke saath sirf Rs 199/seat se.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="bg-brand-blue rounded-2xl p-10 text-white text-center">
            ...
            <h3 className="font-heading font-bold text-2xl mb-2">Custom Enterprise Solution Chahiye?</h3>
            <p className="text-white/70 mb-6">100+ seats, custom integrations, on-site training — sab negotiate ho sakta hai.</p>
