      ...
      <main className="min-h-screen bg-brand-ice pt-24 pb-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{delay:0.4}}
            ...
            <h3 className="font-heading font-bold text-xl mb-2">Ready to start a tech career?</h3>
            <p className="text-white/70 text-sm mb-5">
              {(stats as any)?.totalCourses > 0 ? `${(stats as any).totalCourses}+ courses` : 'Courses'} for just Rs 399. Certificate, projects, lifetime access — all included.
            </p>
