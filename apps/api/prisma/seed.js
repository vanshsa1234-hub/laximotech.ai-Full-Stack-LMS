...
async function main() {
    ...
    const admin = await prisma.user.upsert({
        ...
        create: { email: 'admin@laximotech.ai', name: 'Laximotech Admin', role: client_1.Role.ADMIN },
    });
    const instructor = await prisma.user.upsert({
        where: { email: 'instructor@laximotech.ai' }, update: {},
        create: { email: 'instructor@laximotech.ai', name: 'Rahul Sharma', role: client_1.Role.INSTRUCTOR, bio: '8+ years AI/ML | Ex-Google | IIT Delhi', city: 'Greater Noida West' },
    });
    ...
    const student = await prisma.user.upsert({
        ...
        create: { email: 'demo@laximotech.ai', name: 'Demo Student', role: client_1.Role.STUDENT, xpPoints: 450, streakDays: 7, city: 'Greater Noida West' },
    });
    await prisma.account.upsert({
